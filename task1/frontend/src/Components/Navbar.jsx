    ...
    <>
        <Box position={"fixed"} w="100%" zIndex={"1"} backgroundColor={"blue.900"} height={"75px"} display={"flex"} justifyContent={"space-around"} alignItems={"center"} boxShadow={"rgba(0, 0, 0, 0.24) 0px 3px 8px"} >
            ...
            <Box w="35%" display={"flex"} justifyContent={"space-around"} alignItems={"center"}>
                <Button bg="none" border={"1px solid white"} color={"white"} _hover={{bg:"gray.400",color:"black"}} onClick={()=>navigate("/")}>Movies</Button>
                <Button bg="none" border={"1px solid white"} color={"white"} _hover={{bg:"gray.400",color:"black"}} onClick={()=>navigate("/favourite")}>Favourites</Button>
                <Button bg="none" border={"1px solid white"} color={"white"} _hover={{bg:"gray.400",color:"black"}} onClick={()=>navigate("/watchlist")}>Watchlist</Button>
