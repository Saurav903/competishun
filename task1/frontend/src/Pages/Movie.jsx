    ...
    <>
      <Box className={style.mainnav}>
        <Box className={style.mainnavfix}>
            ...
            <Heading p={"20px"} color={"white"} textDecoration={"underline overline"} textUnderlineOffset={"8px"} textAlign={{sm:"center"}}>Movie App</Heading>

            <Input type="text" placeholder='Search movies' htmlSize={"30"} width='auto' bg={"white"} onChange={(e)=>setSearch(e.target.value)} display={{sm:"none",lg:"block"}}/>


            <Box className={style.navbutton} display={{sm:"none",lg:"block"}}>
